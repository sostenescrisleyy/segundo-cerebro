...
**Versão:** GSAP 3.x (todos os plugins gratuitos após aquisição pela Webflow)  
**Princípio:** Use GSAP quando precisar de: sequenciamento complexo, scroll-linked animations, controle preciso de tempo, ou animações que CSS não consegue fazer bem.

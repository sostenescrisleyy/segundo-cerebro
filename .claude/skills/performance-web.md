...
description: >
  Use para otimização de performance web, Core Web Vitals, bundle size, rendering e SEO de
  velocidade. Ative para: "performance", "lento", "otimizar", "LCP", "CLS", "INP", "bundle
  grande", "lighthouse score baixo", "web vitals", "carregar mais rápido", "Largest Contentful
  Paint", "Cumulative Layout Shift", "Time to First Byte", "code splitting", "lazy loading
  componentes", "tree shaking", "imagem lenta", "fonte bloqueando", "script bloqueando",
  "will-change", "virtual scroll", "memoização", "useCallback performance".
---
...
→ `references/imagens-otimizadas.md` — WebP, AVIF, LQIP, blur placeholder, CDN de imagens
→ `references/cache-estrategias.md` — SWR, React Query cache, Service Worker, CDN cache

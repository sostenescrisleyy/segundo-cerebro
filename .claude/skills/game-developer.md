...
name: game-developer
description: >
  Use para desenvolvimento de jogos web, mobile e PC. Seleção de engine, lógica de jogo,
  padrões de design e otimização de performance. Ative para: "jogo", "game", "unity", "godot",
  "phaser", "pygame", "unreal", "multiplayer", "game loop", "game design", "física de jogo",
  "colisão", "sprite", "tilemap", "sistema de pontuação", "save game", "input de jogo",
  "pathfinding", "IA de inimigo", "câmera de jogo", "partícula", "efeito visual jogo".
---

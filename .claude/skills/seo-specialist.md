...
name: seo-specialist
description: >
  Use para SEO técnico, GEO (otimização para motores de busca generativos como ChatGPT e
  Perplexity), meta tags, Core Web Vitals, dados estruturados e estratégia de conteúdo.
  Ative para: "SEO", "ranqueamento Google", "meta tags", "dados estruturados", "schema markup",
  "sitemap", "robots.txt", "Open Graph", "performance SEO", "E-E-A-T", "GEO", "AI search",
  "aparecer no ChatGPT", "aparecer no Perplexity", "otimizar para IA", "llms.txt",
  "canonical", "indexação", "Core Web Vitals SEO", "rich results", "snippet destacado".
---
...
→ `references/keywords-research.md` — Pesquisa de palavras-chave, intenção de busca
→ `references/link-building.md` — Estratégias de backlinks para SaaS brasileiro

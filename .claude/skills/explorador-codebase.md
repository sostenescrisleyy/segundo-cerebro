---
name: explorador-codebase
description: >
  Use para descoberta e reconhecimento de codebase. Mapeia dependências, encontra padrões,
  entende arquitetura e avalia viabilidade ANTES de implementar. Agente somente-leitura.
  Ative para: "explorar código", "entender projeto", "mapear dependências", "como está organizado",
  "o que esse código faz", "analisar arquitetura", "encontrar padrão", "descobrir",
  "overview do projeto", "quais libs usam", "como funciona autenticação", "onde fica",
  "quero entender antes de mexer", "avaliar complexidade", "estimativa de esforço".
---

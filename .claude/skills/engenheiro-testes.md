...
description: >
  Use para escrever testes unitários, de integração e E2E. Especialista em TDD, cobertura
  de testes e qualidade de código. Ative para: "testes", "escrever teste", "cobertura",
  "jest", "vitest", "playwright", "cypress", "TDD", "mock", "spy", "fixture",
  "teste de componente", "teste de API", "teste de integração", "teste E2E",
  "MSW mock service worker", "teste assíncrono", "snapshot test", "coverage report",
  "teste de regressão", "adicionar testes ao projeto existente".
---
...
→ `references/mocking-avancado.md` — Spies, stubs, módulos complexos
→ `references/playwright-patterns.md` — Page Object Model, fixtures, auth state

---
name: arqueologista-codigo
description: >
  Use para refatorar código legado com segurança, reduzir dívida técnica e modernizar sistemas
  sem quebrar o que funciona. Aplica o Princípio da Cerca de Chesterton e o padrão Strangler Fig.
  Ative para: "código legado", "refatorar", "dívida técnica", "código antigo", "modernizar",
  "migração", "limpeza de código", "reescrita", "código difícil de entender", "sem testes",
  "spaghetti code", "God class", "função gigante", "duplicação", "magic numbers",
  "código que ninguém entende", "precisa refatorar mas com medo de quebrar".
---
...
→ `references/strangler-fig-exemplos.md` — Exemplos reais do padrão em Node.js e React
→ `references/catalogo-refatoracoes.md` — Refatorações completas com antes/depois

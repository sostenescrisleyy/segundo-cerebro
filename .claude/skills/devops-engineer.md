...
description: >
  Use para deploy em produção, infraestrutura, CI/CD, Docker, VPS, Nginx, PM2, monitoramento
  e rollback. Ative para: "deploy", "docker", "ci/cd", "nginx", "pm2", "servidor", "VPS",
  "pipeline", "GitHub Actions deploy", "Vercel", "Railway", "DigitalOcean", "Hetzner",
  "variável de ambiente produção", "SSL certificado", "domínio", "reverse proxy",
  "zero downtime", "rollback", "backup banco", "monitorar aplicação", "logs produção",
  "container", "dockerfile", "docker-compose produção", "health check", "auto deploy".
---
...
→ `references/monitoramento.md` — Uptime Kuma, Grafana, alertas, métricas
→ `references/backup-restore.md` — Estratégias de backup automatizado do PostgreSQL

...
description: >
  Use para decompor tarefas complexas, mapear dependências e criar PLANO.md antes de codificar.
  Ative para: "planejar", "como implementar", "decompor tarefa", "antes de codar", "roadmap
  técnico", "quais arquivos vão mudar", "por onde começar", "dependências entre tarefas",
  "arquitetura", "estime o esforço", "o que vem antes do quê", "implementar feature grande",
  "estruturar o trabalho", "criar plano de ação", "breakdown de tarefa", "como abordar isso".
---
